  ...
  public User enterInfoUser() {
    ...
    while (true) {
      if (firstName.isEmpty() || !firstName.matches("[a-zA-Z\\s]+")) {
        System.out.println("First Name not a vaild or empty, Please enter again!");
        System.out.print("Enter your First Name: ");
    ...
    while (true) {
      if (lastName.isEmpty() || !firstName.matches("[a-zA-Z\\s]+")) {
        System.out.println("Last Name not a vaild or empty, Please enter again!");
        System.out.print("Enter your Last Name: ");
    ...
    while (true) {
      if (account.isEmpty() || !account.matches("[a-zA-Z0-9\\_]+")) {
        System.out.println("Account not a vaild empty, Please enter again!");
        System.out.print("Enter your Account: ");
        account = sc.nextLine();
      } else {
        break;
